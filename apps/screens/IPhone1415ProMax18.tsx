...
const IPhone1415ProMax18 = () => {
  ...
  return (
    <View style={styles.iphone1415ProMax4}>
      <LinearGradient
        style={styles.iphone1415ProMax4Child}
        locations={[0, 0.61, 1]}
        colors={["#50c9dc", "#5687b1", "#5b538f"]}
      />
      <Text style={[styles.logIn, styles.orTypo]}>Log in | Sign up</Text>
      <View style={[styles.iphone1415ProMax4Item, styles.groupInnerLayout]} />
 ...
 So you are mobile number`}</Text>
      <Image
        style={[styles.iphone1415ProMax4Inner, styles.iconChildLayout]}
        contentFit="cover"
      ...
      />
      <Image
        style={[styles.iphone1415ProMax4Child1, styles.iconChildLayout]}
        contentFit="cover"
        source={require("../assets/ellipse-2.png")}
      />
      <Image
        style={[styles.iphone1415ProMax4Child2, styles.iconChildLayout]}
        contentFit="cover"
        source={require("../assets/ellipse-4.png")}
      />
      ...
      <Image
        style={[styles.iphone1415ProMax4Child3, styles.iphone1415Position]}
        contentFit="cover"
